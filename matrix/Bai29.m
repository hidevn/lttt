% Phan code nam trong file mylu, file nay chi chua chung minh :D
...
% co |u(k+1)| = |d(k+1) - l(k+1)*c(k)| >= |d(k+1)| - |l(k+1)*c(k)| >
% |c(k+1)|.
% |c(n)| = 0 => dpcm
...
% => UU^(-1) = L'^(-1)L'
% L'^(-1)L' la ma tran tam giac duoi, con UU^(-1) la ma tran tam giac tren
